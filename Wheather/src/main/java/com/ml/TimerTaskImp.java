...
//		alignChequer(count2, firstone,secondone,thirthdone,thirthdonepos);
//		triangleChequer(count2, firstone,secondone,thirthdone,thirthdonepos);
		checkSameLine();
			
	}

	private void checkSameLine() {
		double x1 = Math.cos(firstone);
		double y1 = Math.sin(firstone);
		double x2 = Math.cos(secondone);
		double y2 = Math.sin(secondone);
		double x3 = Math.cos(thirthdone);
		double y3 = Math.sin(thirthdone);
